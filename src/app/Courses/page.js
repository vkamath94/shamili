    ...
    <section className="bg-white py-12">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold text-gray-900">Admission Criteria</h2>
          <p className="mt-4 text-lg text-gray-600">
            Admission to Pre-University Courses is open to candidates who have passed one of the following:
          </p>
          <ul className="list-disc list-inside text-gray-700 mt-4">
            <li>S.S.L.C. Examination conducted by the Karnataka Secondary Education Examination Board</li>
            <li>Matriculation Examination of an Indian University</li>
            <li>Any other examination recognized by the Board as equivalent to the Matriculation Examination</li>
          </ul>
        </div>

        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold text-gray-900">Course Combinations</h2>
          <p className="mt-4 text-lg text-gray-600">
            Our Pre-University Courses offer the following subject combinations:
          </p>
        </div>
